...
path = r"C:\Users\Conor Tehan\Documents\Software Development Bootcamp\Visual Studio Bootcamp\Week_9_coding\hills-2836301_640.jpg"
def launch_window():
    """
    ...
    label = tk.Label(new_window, text = 'This is a new window!', font = ('Comins sans', 30), fg = "red")
    label.pack(pady = 20)
    label.pack()
